...
# colour map
label_colors_global = [ (128, 64, 128),  # 'road'
                        (244, 35, 232),  # 'sidewalk'
                        (70, 70, 70),    # 'building'
                        (102, 102, 156),  # 'wall'
                        (190, 153, 153),  # 'fence'
...
#    num_classes= num_classes+1
    ...
    assert (num_classes == len(colors)), 'num_classes %d should be equal the number colours %d.' % \
