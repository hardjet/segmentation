...
class BasicModel:
    ...
    def init_summaries(self):
        ...
        with tf.name_scope('segmented_output'):
            ...
            # preds_summary = tf.py_function(decode_labels, [self.out_argmax, self.params.num_classes], tf.uint8)
